...
$vidInfo = json_decode(file_get_contents("https://invidious.zee.li/api/v1/videos/".$id)); //decode the data
...
Loading...
  ...
  <?php
  ob_start();
		  $commentList = json_decode(file_get_contents('https://invidious.zee.li/api/v1/comments/'.$id));
...
if(file_get_contents('https://invidious.zee.li/api/v1/comments/'.$id) == null) {
	ob_end_clean();
